...
void SLIDER_getVal(tWord *);

void SLIDER_update(void);
# 10 "VolumeControl.c" 2
...
# 12 "VolumeControl.c" 2

# 1 "./GPIO.h" 1
# 13 "VolumeControl.c" 2
...
void main(void) {
    ...
    SLIDER_init();
    DSP_init();
    (((((*((volatile tRegister8 *)(0x87))).Reg)) = ((((*((volatile tRegister8 *)(0x87))).Reg) & (~(1 << (5)))) | (((0)) << (5)))));
    (((((*((volatile tRegister8 *)(0x07))).Reg)) = ((((*((volatile tRegister8 *)(0x07))).Reg) & (~(1 << (5)))) | ((0) << (5)))));
...
void __attribute__((picinterrupt(("high_priority")))) ISR(void){
    ...
    if((((*((volatile tRegister8 *)(0x0B))).Bits.BIT2))) {
        ((((((*((volatile tRegister8 *)(0x07))).Reg)) = ((((*((volatile tRegister8 *)(0x07))).Reg) & (~(1 << (5)))) | (!((((*((volatile tRegister8 *)(0x07))).Reg) >> (5)) & (1)) << (5))))));
        SLIDER_update();
        DSP_update();
        (((*((volatile tRegister8 *)(0x0B))).Bits.BIT2)) = 0;
        timer0_reload(216);
