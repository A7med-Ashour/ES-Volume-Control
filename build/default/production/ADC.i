...
void ADC_init(void){
    ...
    (((((*((volatile tRegister8 *)(0x85))).Reg)) = ((((*((volatile tRegister8 *)(0x85))).Reg) & (~(1 << (1)))) | (((1)) << (1)))));


    ((*((volatile tRegister8 *)(0x1F))).Bits.BIT0 = 0);


    ((*((volatile tRegister8 *)(0x9F))).Reg = ((*((volatile tRegister8 *)(0x9F))).Reg & 0xF0) | (0x02));


    ((*((volatile tRegister8 *)(0x1F))).Bits.BIT6) = (1) & 1; ((*((volatile tRegister8 *)(0x1F))).Bits.BIT7) = ((1) & 2) >> 1; ((*((volatile tRegister8 *)(0x9F))).Bits.BIT6) = ((1) & 4) >> 2;;


    ((*((volatile tRegister8 *)(0x9F))).Bits.BIT7 = (1));
...
void ADC_read(tADC_Channel ch,tWord * pval){
   ...
   ((*((volatile tRegister8 *)(0x1F))).Bits.BIT0 = 1);


    ((*((volatile tRegister8 *)(0x1F))).Reg = ((*((volatile tRegister8 *)(0x1F))).Reg & 0xC7) | (ch << 3));


    _delay((unsigned long)((30)*(8000000/4000000.0)));


   ((*((volatile tRegister8 *)(0x1F))).Bits.BIT2 = 1);


    while(((*((volatile tRegister8 *)(0x1F))).Bits.BIT2));



    *pval = (((1)) ? ( ( ( (tWord)(ADRESH)) << 8 ) | ADRESL ) : ( ( ( (tWord) (ADRESH) ) << 2 ) | (ADRESH >> 6 ) ) );
